...
void PacketEncoder::WriteByteArray(uint8_t* bytes, int length, Packet& packet)
{
...
void PacketEncoder::WriteIntArray(uint32_t* ints, int length, Packet& packet)
{
    for (int i = 0; i < length; i++)
    {
...
void PacketEncoder::WriteLongArray(uint64_t* longs, int length, Packet& packet)
{
    for (int i = 0; i < length; i++)
    {
